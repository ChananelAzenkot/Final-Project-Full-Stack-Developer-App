...
SalesIncrementalTeamsMonthlyAVG.propTypes = {
...
export default function SalesIncrementalTeamsMonthlyAVG({
  selectedMonthSales,
  ...
  useEffect(() => {
    fetch(
      `http://localhost:4000/api/SalesIncrementalTeamsMonthlyAVG`,
      {
        credentials: "include",
        method: "GET",
        headers: {
