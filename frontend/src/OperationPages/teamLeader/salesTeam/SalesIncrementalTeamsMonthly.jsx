...
import SalesIncrementalTeamsMonthlyAVG from "./SalesIncrementalTeamsMonthlyAVG";
...
export default function SalesIncrementalTeamsMonthly() {
  ...
  useEffect(() => {
    ...
    fetch(`http://localhost:4000/api/SalesIncrementalTeamsMonthly`, {
      credentials: "include",
      method: "GET",
      headers: {
    ...
    <>
      {!seller.length ? (
        <div className="titleOperationAndAgents">
          <h3>{`  אין עדין מכירות לחודש הנוכחי בצוות`}</h3>
        </div>
      ) : (
        <>
          <div className="titleOperationAndAgents">
          ...
          {!filterOperationSales.length ? (
            ...
            <>
              ...
              <SalesIncrementalTeamsMonthlyAVG
