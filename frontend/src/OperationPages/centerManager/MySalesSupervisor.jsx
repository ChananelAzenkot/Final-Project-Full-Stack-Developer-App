...
export default function MySalesSupervisor() {
  ...
  return operation.nameAgent === selectedAgent && operationMonth === selectedMonthSales && operation.teamName === selectedTeam;
});
  ...
  return (
    ...
    <>
      <div className="titleOperationAndAgents">
        <h3>{`תפעול מכירות של צוות : ${moment(selectedMonthSales, "MM/YYYY").format(
          "MM/YYYY"
        )}`}</h3>
      <FormControl
            variant="standard"
  ...
  <FormControl
    ...
    <Select
      ...
      <div className="titleOperationAndAgents">
        <h3 style={{ fontSize: "20px" }}>{`סך הביצועים ${selectedAgent} החודש . `}</h3>
      </div>
