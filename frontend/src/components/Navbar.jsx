...
export default function Navbar() {
  const {anchorElNav,anchorElUser,handleOpenNavMenu,
    handleOpenUserMenu,handleCloseNavMenu,handleCloseUserMenu,
  } = useAnchors();
  ...
  const logout = useLogout( setUser, setUserRoleType, setLoader,
        ...
        <Toolbar disableGutters>
          ...
          <Typography variant="h5" noWrap component="a" href="/"
            sx={{
              ...
              color: "inherit",
              textDecoration: "none",}}>
            <b style={{ fontFamily: "initial" }}> ⚡️GoPartner</b>
          </Typography>
              ...
              <Menu
                ...
                <Link
                  ...
                  <MenuItem onClick={handleCloseUserMenu}>
                    <Typography textAlign="center">{user.nameAgent}</Typography>
                  </MenuItem>
                </Link>
